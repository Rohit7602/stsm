...
const NewCategory = ({ setOpen, open }) => {
  ...
  const [mainCategory, setMainCategory] = useState([]);
    ...
    async function handleSave(e){
      e.preventDefault()
      try {
        if ( name==undefined && category == undefined && status == undefined) {
          alert(
 ...
 if(loaderstatus){
  ...
  return  <div className="main_panel_wrapper pb-4  bg_light_grey w-100 d-flex flex-column">
  {/* top-bar  */}
    ...
    <div className="container">
      <div className="d-flex  align-items-center flex-column flex-sm-row gap-2 gap-sm-0  justify-content-between">
        ...
        <div className="d-flex align-itmes-center gap-3">
          ...
          <button onClick={handleSave} className="fs-sm d-flex gap-2 mb-0 align-items-center px-sm-3 px-2 py-2 save_btn fw-400 black">
