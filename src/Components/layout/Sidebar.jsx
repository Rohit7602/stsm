            ...
            <ul className="px-0 drop_list">
              ...
              >
                {!distributor ? (
                  ...
                  <div className="d-flex align-items-center w-100 dash_links justify-content-between opacity-75 cursor_not_allowed">
                    <h3 className="fs-xs fw-400 white mb-0">Dashboard</h3>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      x="0px"
              ...
              <li>
                ...
                {openDropdown === "setting" && (
                  <ul className="ps-0">
                    ...
                    <li>
                      <NavLink className="dash_links_inner" to="setting/productslogs">
                        <h3 className="fs-xs fw-400  white mb-0">Products Logs</h3>
                      </NavLink>
                    </li>
                  </ul>
                )}
