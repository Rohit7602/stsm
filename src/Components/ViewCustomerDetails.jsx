          ...
          <Row className="mt-3">
            <Col xxl={4}>
              ...
              <div className="product_shadow bg_white d-flex flex-column justify-content-center align-items-center p-3">
                <img
                  className="manimage"
                  src={!data.image ? manimage : data.image}
                  alt="manimage"
                />
                ...
                <div className="overflow_lg_scroll">
                  <div className="customer_lg_overflow_X">
                    ...
                    <div className="d-flex justify-content-between align-items-center mt-3">
                      <h2 className="fw-400 fs-sm black mb-0 mt-3 width_15 "> Order No. </h2>
                      <h2 className="fw-400 fs-sm black mb-0 mt-3 width_15 "> Order Date </h2>
                      <h2 className="fw-400 fs-sm black mb-0 mt-3 width_15 "> Status </h2>
                      <h2 className="fw-400 fs-sm black mb-0 mt-3 width_15 "> Items </h2>
                    ...
                    <div className="d-flex justify-content-between align-items-center mt-3">
                      ...
                      <h2 className="fw-400 fs-sm black mb-0 mt-3 width_15 "> 01-01-2023 </h2>
                      <h2 className="fw-400 fs-sm black mb-0 mt-3 width_15 "> Pending </h2>
                      <h2 className="fw-400 fs-sm black mb-0 mt-3 width_15 "> 2 items </h2>
                      <h2 className="fw-400 fs-sm black mb-0 mt-3 width_15 me-2">₹ 1,260.00</h2>
                    </div>
                    <div className="product_borderbottom mt-3"></div>
                    {/* 3rd */}
                    <div className="d-flex justify-content-between align-items-center mt-3">
