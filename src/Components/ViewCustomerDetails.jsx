          ...
          <Row className="mt-3">
            <Col xxl={4}>
              ...
              <div className="product_shadow bg_white d-flex flex-column justify-content-center align-items-center p-3">
                <img className="manimage" src={manimage} alt="manimage" />
                <h2 className="fw-700 fs-2sm black mb-0 mt-3">John Doe</h2>
                <h2 className="fw-400 fs-2sm black mb-0 mt-2">
                  john@example.com
                </h2>
                <h2 className="fw-400 fs-2sm black mb-0 ">+91 12345 12345</h2>
              </div>
              {/*   last order */}
